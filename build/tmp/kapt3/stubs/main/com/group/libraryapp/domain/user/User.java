...
public final class User {
    ...
    private final java.util.List<com.group.libraryapp.domain.user.loadhistory.UserLoanHistory> userLoanHistories = null;
    @org.jetbrains.annotations.Nullable()
    ...
    java.util.List<com.group.libraryapp.domain.user.loadhistory.UserLoanHistory> userLoanHistories, @org.jetbrains.annotations.Nullable()
    java.lang.Long id) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.group.libraryapp.domain.user.loadhistory.UserLoanHistory> getUserLoanHistories() {
        return null;
    }
